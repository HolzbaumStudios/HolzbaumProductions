...
public class turnAchievementsOnClick : MonoBehaviour {
	...
	IEnumerator TurnPlay() {
		...
		squareH.transform.FindChild ("Letter").gameObject.SetActive (false);
